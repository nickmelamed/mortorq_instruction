...
The most common thing to wrap in RAII is a raw pointer itself — and C++ provides ready-made types for exactly this, so you rarely need to write the wrapper by hand the way `FaultStack` did.
