...
## Goal
For each dependency in a real `requirements.txt`, decide whether its version is pinned too loosely, too tightly (and gone stale), or reasonably. Justify each call using semver.
