...
├── 15_code_review/                          Reviewing someone else's change well, and receiving review without taking it personally
├── 16_pair_programming_and_workflow/        Driver/navigator pairing, Kanban vs. sprints, and what "done" actually means
├── 17_onboarding_and_mentorship/            The veteran's-side companion to 10: leaving a map, instead of making newcomers rediscover one
└── README.md                                This file
```
