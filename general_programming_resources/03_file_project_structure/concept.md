...
3. **Find the entry point.** Every runnable project has to start somewhere, be that a `main`, a `Main` class, an `index`. Once you know where execution *begins*, you have a thread to follow into everything else.
