...
2. Write a **for a mentor or judge with no CS background** version: 2-4 sentences, no code, no specific amp values required — but still true, and still specific enough to show a deliberate decision was made, not just "we fixed a bug."
